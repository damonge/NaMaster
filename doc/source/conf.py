...
# -*- coding: utf-8 -*-
#
# pymaster documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'pymaster.tex', 'pymaster Documentation',
     'David Alonso', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymaster', 'pymaster Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pymaster', 'pymaster Documentation',
     author, 'pymaster', 'One line description of project.',
     'Miscellaneous'),
]
