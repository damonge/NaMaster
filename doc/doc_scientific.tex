...
\section{Flat-sky}
  \subsection{Fourier transforms}
    In the flat sky we will write the directional vector $\nv$ as ${\bf x}$. Let ${\bf a}({\bf x})$ be a spin-$s_a$ quantity. Under the approximation $\sin\theta\sim1$, $\Delta\theta\rightarrow \Delta x$, $\Delta\phi\rightarrow\Delta y$, the differential operator $\eth$ now takes the form:
    \begin{equation}
      \eth=-(\partial_x+i\partial_y),\hspace{12pt}\bar{\eth}=-(\partial_x-i\partial_y),
    \end{equation}
    and acts on a plane wave $e^{i{\bf k}{\bf x}}$ as:
    \begin{equation}
      \eth^s e^{i{\bf k}{\bf x}}=(-ik)^se^{i\,s\phi_k}e^{i{\bf k}{\bf x}},\hspace{12pt}
      \bar{\eth}e^{i{\bf k}{\bf x}}=(-ik)^se^{-i\,s\phi_k}e^{i{\bf k}{\bf x}}
    \end{equation}

    Let us define the basis functions:
    \begin{equation}
      \,_s{\cal Y}_{\bf k}({\bf x})\equiv k^{-s}\eth^se^{i{\bf k}{\bf x}}=(-i)^se^{is\phi_k}e^{i{\bf k}{\bf x}},\hspace{12pt}\,
      _{-s}{\cal Y}_{\bf k}({\bf x})\equiv (-k)^{-s}\bar{\eth}^se^{i{\bf k}{\bf x}}=i^se^{-is\phi_k}e^{i{\bf k}{\bf x}},
    \end{equation}
    ...
    \begin{align}
      ...
      &=-(-i)^s
      \left(\begin{array}{cc}
                 \cos(s\phi_l) & \sin(s\phi_l) \\
                -\sin(s\phi_l) & \cos(s\phi_l)
            \end{array}\right)e^{i{\bf l}{\bf x}}\\
      &=-(-i)^s{\sf R}(\phi_l)e^{i{\bf l}{\bf x}},
    \end{align}
    where ${\sf R}(\phi)$ is a rotation matrix.
  ...
  \subsection{Pseudo-$C_\ell$ estimator}
    ...
    \begin{align}
      {\bf a}^v_{\bf l}&=\int\int\frac{d{\bf k}^2d{\bf q}^2}{2\pi}\left[\int\frac{d{\bf x}^2}{(2\pi)^2}\,_{s_a}{\sf E}^\dag_{\bf l}({\bf x})\,_{s_a}{\sf E}_{\bf k}({\bf x})\,_0E_{\bf q}({\bf x})\right]{\bf a}_{\bf k}\,v_{\bf q}\\
                       &=\int\frac{d{\bf k}^2}{2\pi}{\sf R}^\dag\left(s(\phi_{\bf l}-\phi_{\bf k})\right)\,{\bf a}_{\bf k}v_{{\bf l}-{\bf k}}
    \end{align}
    Then:
    \begin{align}
      \left\langle\tilde{\bf a}_{\bf l}\,\tilde{\bf b}^\dag_{\bf l}\right\rangle
      &=\int\int\frac{dk^Ddq^D}{(2\pi)^D}{\sf R}^\dag(s_a(\phi_{\bf l}-\phi_{\bf k}))\left\langle{\bf a}_{\bf k}{\bf b}^\dag_{\bf q}\right\rangle{\sf R}(s_b(\phi_{\bf l}-\phi_{\bf q}))v_{{\bf l}-{\bf k}}w^*_{{\bf l}-{\bf q}}\\
      &=\int\frac{dk^D}{(2\pi)^D}{\sf R}^\dag(s_a(\phi_{\bf l}-\phi_{\bf k})){\sf C}^{ab}_k{\sf R}(s_b(\phi_{\bf l}-\phi_{\bf k}))v_{{\bf l}-{\bf k}}w^*_{{\bf l}-{\bf k}}
    \end{align}
    \begin{align}
      \left(\frac{L}{2\pi}\right)^D\tilde{\sf C}^{\tilde{a}\tilde{b}}_\ell&\equiv\int\frac{d\phi_{\bf l}}{2\pi}\left\langle\tilde{\bf a}_{\bf l}\,\tilde{\bf b}^\dag_{\bf l}\right\rangle\\
      &=\int\frac{kdk\,qdq}{(2\pi)^D}\left[\int d\phi_{\bf l}d\phi_{\bf k}d\phi_{\bf q}{\sf R}^\dag(s_a(\phi_{\bf l}-\phi_{\bf k})){\sf C}^{ab}_k{\sf R}(s_b(\phi_{\bf l}-\phi_{\bf k}))v_{{\bf q}}w^*_{{\bf q}}\delta({\bf l}-{\bf k}-{\bf q})\right]
    \end{align}
