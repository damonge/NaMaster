...
class binning_scheme(_object):
    ...
    if _newclass:ell_max = _swig_property(_nmtlib.binning_scheme_ell_max_get, _nmtlib.binning_scheme_ell_max_set)
    def __init__(self): 
...
class workspace_flat(_object):
    ...
    if _newclass:pe1 = _swig_property(_nmtlib.workspace_flat_pe1_get, _nmtlib.workspace_flat_pe1_set)
    __swig_setmethods__["pe2"] = _nmtlib.workspace_flat_pe2_set
    __swig_getmethods__["pe2"] = _nmtlib.workspace_flat_pe2_get
    if _newclass:pe2 = _swig_property(_nmtlib.workspace_flat_pe2_get, _nmtlib.workspace_flat_pe2_set)
    __swig_setmethods__["pb1"] = _nmtlib.workspace_flat_pb1_set
    __swig_getmethods__["pb1"] = _nmtlib.workspace_flat_pb1_get
    if _newclass:pb1 = _swig_property(_nmtlib.workspace_flat_pb1_get, _nmtlib.workspace_flat_pb1_set)
    __swig_setmethods__["pb2"] = _nmtlib.workspace_flat_pb2_set
    __swig_getmethods__["pb2"] = _nmtlib.workspace_flat_pb2_get
    if _newclass:pb2 = _swig_property(_nmtlib.workspace_flat_pb2_get, _nmtlib.workspace_flat_pb2_set)
    ...
    if _newclass:lmax = _swig_property(_nmtlib.workspace_flat_lmax_get, _nmtlib.workspace_flat_lmax_set)
    ...
    if _newclass:coupling_matrix_binned_gsl = _swig_property(_nmtlib.workspace_flat_coupling_matrix_binned_gsl_get, _nmtlib.workspace_flat_coupling_matrix_binned_gsl_set)
...
def couple_cl_l_flat_fast(*args):
  return _nmtlib.couple_cl_l_flat_fast(*args)
couple_cl_l_flat_fast = _nmtlib.couple_cl_l_flat_fast

def couple_cl_l_flat_quick(*args):
  return _nmtlib.couple_cl_l_flat_quick(*args)
