...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_nmtlib')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_nmtlib')
...
class flatsky_info(_object):
    ...
    if _newclass:
        n_cells = _swig_property(_nmtlib.flatsky_info_n_cells_get, _nmtlib.flatsky_info_n_cells_set)
...
def field_alloc_sph(nside, mask, pol, maps, ntemp, temp, beam, pure_e, pure_b):
    return _nmtlib.field_alloc_sph(nside, mask, pol, maps, ntemp, temp, beam, pure_e, pure_b)
field_alloc_sph = _nmtlib.field_alloc_sph

def field_read(fname_mask, fname_maps, fname_temp, fname_beam, pol, pure_e, pure_b):
    return _nmtlib.field_read(fname_mask, fname_maps, fname_temp, fname_beam, pol, pure_e, pure_b)
...
class workspace_flat(_object):
    ...
    if _newclass:
        nl_rebin = _swig_property(_nmtlib.workspace_flat_nl_rebin_get, _nmtlib.workspace_flat_nl_rebin_set)
    __swig_setmethods__["nells"] = _nmtlib.workspace_flat_nells_set
    __swig_getmethods__["nells"] = _nmtlib.workspace_flat_nells_get
    if _newclass:
        nells = _swig_property(_nmtlib.workspace_flat_nells_get, _nmtlib.workspace_flat_nells_set)
    ...
    if _newclass:
        pcl_masks = _swig_property(_nmtlib.workspace_flat_pcl_masks_get, _nmtlib.workspace_flat_pcl_masks_set)
    __swig_setmethods__["l_arr"] = _nmtlib.workspace_flat_l_arr_set
    __swig_getmethods__["l_arr"] = _nmtlib.workspace_flat_l_arr_get
    if _newclass:
        l_arr = _swig_property(_nmtlib.workspace_flat_l_arr_get, _nmtlib.workspace_flat_l_arr_set)
    __swig_setmethods__["i_band"] = _nmtlib.workspace_flat_i_band_set
    __swig_getmethods__["i_band"] = _nmtlib.workspace_flat_i_band_get
    if _newclass:
        i_band = _swig_property(_nmtlib.workspace_flat_i_band_get, _nmtlib.workspace_flat_i_band_set)
...
def compute_coupling_matrix_flat(fl1, fl2, bin, nl_rebin, method_flag, lmn_x, lmx_x, lmn_y, lmx_y):
    return _nmtlib.compute_coupling_matrix_flat(fl1, fl2, bin, nl_rebin, method_flag, lmn_x, lmx_x, lmn_y, lmx_y)
compute_coupling_matrix_flat = _nmtlib.compute_coupling_matrix_flat

def compute_deprojection_bias_flat(fl1, fl2, lmn_x, lmx_x, lmn_y, lmx_y, nl_prop, l_prop, cl_proposal, cl_bias):
    return _nmtlib.compute_deprojection_bias_flat(fl1, fl2, lmn_x, lmx_x, lmn_y, lmx_y, nl_prop, l_prop, cl_proposal, cl_bias)
...
def compute_coupled_cell_flat(fl1, fl2, larr, cl_out, lmn_x, lmx_x, lmn_y, lmx_y):
    return _nmtlib.compute_coupled_cell_flat(fl1, fl2, larr, cl_out, lmn_x, lmx_x, lmn_y, lmx_y)
compute_coupled_cell_flat = _nmtlib.compute_coupled_cell_flat

def compute_power_spectra_flat(fl1, fl2, bin, nl_rebin, method_flag, lmn_x, lmx_x, lmn_y, lmx_y, w0, cl_noise, nl_prop, l_prop, cl_prop, cl_out):
    return _nmtlib.compute_power_spectra_flat(fl1, fl2, bin, nl_rebin, method_flag, lmn_x, lmx_x, lmn_y, lmx_y, w0, cl_noise, nl_prop, l_prop, cl_prop, cl_out)
...
class covar_workspace(_object):
    ...
    if _newclass:
        cl_mask_1122 = _swig_property(_nmtlib.covar_workspace_cl_mask_1122_get, _nmtlib.covar_workspace_cl_mask_1122_set)
    ...
    if _newclass:
        cl_mask_1221 = _swig_property(_nmtlib.covar_workspace_cl_mask_1221_get, _nmtlib.covar_workspace_cl_mask_1221_set)
...
def field_alloc_new(npix_1, nmap_2, ntmp_3, nell3, pure_e, pure_b):
    return _nmtlib.field_alloc_new(npix_1, nmap_2, ntmp_3, nell3, pure_e, pure_b)
field_alloc_new = _nmtlib.field_alloc_new

def field_alloc_new_notemp(npix_1, nmap_2, nell3, pure_e, pure_b):
    return _nmtlib.field_alloc_new_notemp(npix_1, nmap_2, nell3, pure_e, pure_b)
...
def comp_deproj_bias_flat(fl1, fl2, lmn_x, lmx_x, lmn_y, lmx_y, nell3, ncl1, dout):
    return _nmtlib.comp_deproj_bias_flat(fl1, fl2, lmn_x, lmx_x, lmn_y, lmx_y, nell3, ncl1, dout)
...
def comp_pspec_coupled_flat(fl1, fl2, dout, lmn_x, lmx_x, lmn_y, lmx_y):
    return _nmtlib.comp_pspec_coupled_flat(fl1, fl2, dout, lmn_x, lmx_x, lmn_y, lmx_y)
...
def get_ell_sampling_flat_wsp(w, dout):
    return _nmtlib.get_ell_sampling_flat_wsp(w, dout)
get_ell_sampling_flat_wsp = _nmtlib.get_ell_sampling_flat_wsp

def get_ell_sampling_flat_field(fl, dout):
    return _nmtlib.get_ell_sampling_flat_field(fl, dout)
...
def comp_pspec_flat(fl1, fl2, bin, w0, n_rebin, ncl1, nell3, ncl2, dout, method, lmn_x, lmx_x, lmn_y, lmx_y):
    return _nmtlib.comp_pspec_flat(fl1, fl2, bin, w0, n_rebin, ncl1, nell3, ncl2, dout, method, lmn_x, lmx_x, lmn_y, lmx_y)
